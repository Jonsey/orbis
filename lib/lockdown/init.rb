Lockdown::System.configure do
 ...
 #   to_model(:vacancy).where(:editor_ids).includes(:current_user_id)
  ...
  set_permission(:manage_applications).
    with_controller(:admin__applications)
  ...
  set_user_group(:candidates, :my_candidate_account, :list_vacancies, :apply_for_vacancies, :manage_applications, :view_documents)
